...
|---|---|---|---|
| Windows 10/11 | Application Deezer via GSMTC ; navigateurs en option | Fonctionnelle via le compte ouvert dans Discord Desktop | `artifacts/windows-win-x64-v1.1.5/DeezerRPC.exe` |
| Android 7+ | Session média Deezer via `NotificationListenerService` | Prête pour Discord Social SDK 1.10+ | `artifacts/android-v1.1.5/DeezerPresence-Android-detector-only-v1.1.5.apk` ; SDK officiel requis pour publier |
