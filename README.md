...
|---|---|---|---|
| Windows 10/11 | Application Deezer via GSMTC ; navigateurs en option | Fonctionnelle via le compte ouvert dans Discord Desktop | `artifacts/windows-win-x64-v1.1.6/DeezerRPC.exe` |
